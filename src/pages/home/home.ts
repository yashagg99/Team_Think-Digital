...
public number;
constructor(public navCtrl: NavController,private googlePlus:GooglePlus,private otpProvider:OtpProvider,public http:Http,private alertCtrl:AlertController,private toastCtrl: ToastController) {
